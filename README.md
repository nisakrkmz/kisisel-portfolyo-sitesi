<div align="center">
<img width="1200" height="475" alt="Nisa Naz Korkmaz - Portfolio" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />
</div>
...
- **Stil:** Lucide Icons, Custom Animations
...
Uygulamaya `http://localhost:3000` adresinden erişebilirsin.

## 🌐 Deployment

### GitHub Pages
Portfolio şu adreste yayınlanmıştır: **[github-pages-linkini-buraya-ekle]**

Kendi GitHub Pages'inde yayınlamak için:
```bash
npm run build
# Build klasörünü GitHub Pages'e yükle
```
...
- **AI Sohbet Botu:** Şu anda mock verilerle çalışmaktadır. Gerçek API entegrasyonu için `AIChat` bileşenini güncelleyin.
...
Bu proje kişisel portfolio amaçlı geliştirilmiştir.